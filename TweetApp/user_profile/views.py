...
class Invite(View):
	...
	def post(self, request):
		...
		if form.is_valid():
			...
			invitation.save()
			success = msg.send()
			return HttpResponseRedirect('/invite?success='+str(success)
			+'&email='+email)
